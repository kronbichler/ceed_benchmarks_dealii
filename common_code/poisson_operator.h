                      ...
                      for (unsigned int i = 0; i < 6 * 6; i += 3)
                        {
                          ...
                          auto       out_ptr =
                            phi_grads + c * n_q_points + i + (2 * n_components * n_q_points_2d);
                          svfloat64_t sp0, sm0, sp1, sm1, sp2, sm2, sp3, sm3, sp4, sm4, sp5, sm5,
                            sp6, sm6, sp7, sm7, sp8, sm8;
                      ...
                      if (n_q_points_1d == 6 && fe_degree == 5)
                        {
                          for (unsigned int i = 0; i < 6; i += 3)
                            {
                              const auto in_ptr =
                                phi.begin_values() + c * n_q_points + i + qz * n_q_points_2d;
                              auto        out_ptr = phi_grads + (2 * c + 1) * n_q_points_2d + i;
                              svfloat64_t sp0, sm0, sp1, sm1, sp2, sm2, sp3, sm3, sp4, sm4, sp5,
                                sm5, sp6, sm6, sp7, sm7, sp8, sm8;
                              svfloat64_t t0, xp0, xm0, xp1, xm1, xp2, xm2, c0, c1;
                          ...
                          for (unsigned int i = 0; i < 36; i += 18)
                            {
                              const auto in_ptr =
                                phi.begin_values() + c * n_q_points + qz * n_q_points_2d + i;
                  ...
                  for (unsigned int qxy = 0; qxy < n_q_points_2d; ++qxy, ++q)
#ifdef __ARM_FEATURE_SVE
                    {
                      ...
                      for (unsigned int c = 0; c < n_components; ++c)
                        {
                          svfloat64_t t0 =
                            svld1_f64(svptrue_b64(), phi_grads[qxy + c * 2 * n_q_points_2d].data);
                          svfloat64_t t1 =
                            svld1_f64(svptrue_b64(),
                                      phi_grads[qxy + (c * 2 + 1) * n_q_points_2d].data);
                          svfloat64_t t2 = svld1_f64(
                            svptrue_b64(),
                          ...
                          for (unsigned int i = 0; i < 36; i += 18)
                            {
                              ...
                              svst1_f64(svptrue_b64(),
                                        ...
                                        svadd_f64_z(svptrue_b64(),
                                                    svld1_f64(svptrue_b64(), out_ptr[0].data),
                                                    svadd_f64_z(svptrue_b64(), sp0, sm0)));
                              svst1_f64(svptrue_b64(),
                                        out_ptr[1].data,
                                        svadd_f64_z(svptrue_b64(),
                                                    svld1_f64(svptrue_b64(), out_ptr[1].data),
                                                    svadd_f64_z(svptrue_b64(), sp3, sm3)));
                              svst1_f64(svptrue_b64(),
                                        out_ptr[2].data,
                                        svadd_f64_z(svptrue_b64(),
                                                    svld1_f64(svptrue_b64(), out_ptr[2].data),
                                                    svadd_f64_z(svptrue_b64(), sp6, sm6)));
                              svst1_f64(svptrue_b64(),
                                        out_ptr[3].data,
                                        svadd_f64_z(svptrue_b64(),
                              ...
                              svst1_f64(svptrue_b64(),
                                        out_ptr[6].data,
                                        svadd_f64_z(svptrue_b64(),
                                                    svld1_f64(svptrue_b64(), out_ptr[6].data),
                                                    svadd_f64_z(svptrue_b64(), sp1, sm1)));
                              svst1_f64(svptrue_b64(),
                                        out_ptr[7].data,
                                        svadd_f64_z(svptrue_b64(),
                                                    svld1_f64(svptrue_b64(), out_ptr[7].data),
                                                    svadd_f64_z(svptrue_b64(), sp4, sm4)));
                              svst1_f64(svptrue_b64(),
                                        out_ptr[8].data,
                                        svadd_f64_z(svptrue_b64(),
                                                    svld1_f64(svptrue_b64(), out_ptr[8].data),
                                                    svadd_f64_z(svptrue_b64(), sp7, sm7)));
                              svst1_f64(svptrue_b64(),
                                        out_ptr[9].data,
                                        svadd_f64_z(svptrue_b64(),
                              ...
                              svst1_f64(svptrue_b64(),
                                        out_ptr[12].data,
                                        svadd_f64_z(svptrue_b64(),
                                                    svld1_f64(svptrue_b64(), out_ptr[12].data),
                                                    svadd_f64_z(svptrue_b64(), sp2, sm2)));
                              svst1_f64(svptrue_b64(),
                                        out_ptr[13].data,
                                        svadd_f64_z(svptrue_b64(),
                                                    svld1_f64(svptrue_b64(), out_ptr[13].data),
                                                    svadd_f64_z(svptrue_b64(), sp5, sm5)));
                              svst1_f64(svptrue_b64(),
                                        out_ptr[14].data,
                                        svadd_f64_z(svptrue_b64(),
                                                    svld1_f64(svptrue_b64(), out_ptr[14].data),
                                                    svadd_f64_z(svptrue_b64(), sp8, sm8)));
                              svst1_f64(svptrue_b64(),
                                        out_ptr[15].data,
                                        svadd_f64_z(svptrue_b64(),
                      ...
                      for (unsigned int i = 0; i < 6 * 6; i += 3)
                        {
                          ...
                          svst1_f64(svptrue_b64(),
                                    out_ptr[36 * 0].data,
                                    svadd_f64_z(svptrue_b64(),
                                                svld1_f64(svptrue_b64(), out_ptr[36 * 0].data),
                                                svadd_f64_z(svptrue_b64(), sp0, sm0)));
                          svst1_f64(svptrue_b64(),
                                    out_ptr[36 * 0 + 1].data,
                                    svadd_f64_z(svptrue_b64(),
                                                svld1_f64(svptrue_b64(), out_ptr[36 * 0 + 1].data),
                                                svadd_f64_z(svptrue_b64(), sp1, sm1)));
                          svst1_f64(svptrue_b64(),
                                    out_ptr[36 * 0 + 2].data,
                                    svadd_f64_z(svptrue_b64(),
                                                svld1_f64(svptrue_b64(), out_ptr[36 * 0 + 2].data),
                                                svadd_f64_z(svptrue_b64(), sp2, sm2)));
                          svst1_f64(svptrue_b64(),
                                    out_ptr[36 * 5].data,
                                    svadd_f64_z(svptrue_b64(),
                          ...
                          svst1_f64(svptrue_b64(),
                                    out_ptr[36 * 1].data,
                                    svadd_f64_z(svptrue_b64(),
                                                svld1_f64(svptrue_b64(), out_ptr[36 * 1].data),
                                                svadd_f64_z(svptrue_b64(), sp3, sm3)));
                          svst1_f64(svptrue_b64(),
                                    out_ptr[36 * 1 + 1].data,
                                    svadd_f64_z(svptrue_b64(),
                                                svld1_f64(svptrue_b64(), out_ptr[36 * 1 + 1].data),
                                                svadd_f64_z(svptrue_b64(), sp4, sm4)));
                          svst1_f64(svptrue_b64(),
                                    out_ptr[36 * 1 + 2].data,
                                    svadd_f64_z(svptrue_b64(),
                                                svld1_f64(svptrue_b64(), out_ptr[36 * 1 + 2].data),
                                                svadd_f64_z(svptrue_b64(), sp5, sm5)));
                          svst1_f64(svptrue_b64(),
                                    out_ptr[36 * 4].data,
                                    svadd_f64_z(svptrue_b64(),
                          ...
                          svst1_f64(svptrue_b64(),
                                    out_ptr[36 * 2].data,
                                    svadd_f64_z(svptrue_b64(),
                                                svld1_f64(svptrue_b64(), out_ptr[36 * 2].data),
                                                svadd_f64_z(svptrue_b64(), sp6, sm6)));
                          svst1_f64(svptrue_b64(),
                                    out_ptr[36 * 2 + 1].data,
                                    svadd_f64_z(svptrue_b64(),
                                                svld1_f64(svptrue_b64(), out_ptr[36 * 2 + 1].data),
                                                svadd_f64_z(svptrue_b64(), sp7, sm7)));
                          svst1_f64(svptrue_b64(),
                                    out_ptr[36 * 2 + 2].data,
                                    svadd_f64_z(svptrue_b64(),
                                                svld1_f64(svptrue_b64(), out_ptr[36 * 2 + 2].data),
                                                svadd_f64_z(svptrue_b64(), sp8, sm8)));
                          svst1_f64(svptrue_b64(),
                                    out_ptr[36 * 3].data,
                                    svadd_f64_z(svptrue_b64(),
